...
// Create a minimal auth configuration for build time when DATABASE_URL is not available
const createAuthConfig = () => {
  ...
  // Only add database and complex configurations if DATABASE_URL is available
